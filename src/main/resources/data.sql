...
insert into users(id, email, first_name, last_name, phone_number, is_active, password, address_id, role_id)
values(100000, '3g.mit02@gmail.com', 'Gebreegziabher', 'Gebru', '+12246399556', true, '$2y$10$K5qgybrE53LEpwNfOl4ROOBTxr4wXi9hfPGDn.ApO6RU.f0psRghy',100000, 1);